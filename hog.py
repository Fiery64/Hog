...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    rightmost_digit_you = player_score % 10
    second_rightmost_digit_opponent = (opponent_score // 10) % 10
    point = 3 * abs(second_rightmost_digit_opponent - rightmost_digit_you)
    if point == 0:
        return 1
    return point
    # END PROBLEM 2
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            if update == fuzzy_update:
                score0 = fuzzy_update(num_rolls, score0, score1, dice)
            elif update == simple_update:
            ...
            elif update == fuzzy_update:
                score1 = fuzzy_update(num_rolls, score1, score0, dice)
            who = 0
    # END PROBLEM 5
